...
class Driver(drivers.BaseDriver):
    ...
    def heartbeat_send(self, identity=None, host_uptime=None, agent_uptime=None,
                       expire=None, source_uuid=None, reset=False):
        """Send a heartbeat.
    ...
    def heartbeat_server_receive(self):
        ...
        try:
            ...
            loaded_data = {}
        parts = (identity.decode(), control.decode(),
                loaded_data.get("host_uptime", None),
                loaded_data.get("agent_uptime", None),
                loaded_data.get("source_uuid", None),
                loaded_data.get("version", None))
        self.log.debug("Received heartbeat: {}".format(parts))
        return parts
